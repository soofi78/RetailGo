    ...
    public partial class ProcessingPaymentPage : Page
    {
        ...
        void Print()
        {
            try
            {
                ...
                BytesValue = PrintExtensions.AddBytes(BytesValue, Encoding.ASCII.GetBytes("RetailGo\n\n"));
                ...
                BytesValue = PrintExtensions.AddBytes(BytesValue, Encoding.ASCII.GetBytes(ApplicationStateContext.SalesOrderRequestObject.salesOrder.netTotal+"\n\n"));
                BytesValue = PrintExtensions.AddBytes(BytesValue, escPosEpson.Separator());
