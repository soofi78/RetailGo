    ...
    public partial class PaymentMethodViewModel : BaseResturantViewModel
    {
        ...
        private SalesOrderRequest GetSalesOrderRequest()
        {
            ...
            salesOrderRequest.salesOrder = new SalesOrder()
            {
                ...
                referralCode = ApplicationStateContext.ReferralCode,
                Remarks = ApplicationStateContext.CustomerDetailsObj?.Remarks,
                contactNo = ApplicationStateContext.CustomerDetailsObj?.ContactNumber,
                address1 = ApplicationStateContext.CustomerDetailsObj?.AddressLine1,
                address2 = ApplicationStateContext.CustomerDetailsObj?.AddressLine2,
